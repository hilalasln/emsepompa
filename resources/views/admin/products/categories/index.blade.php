                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title float-right">
                                <a class="btn btn-success" href="{{ url('NPanel/products/categories/crud') }}"> <i class="fas fa-plus"></i> <span>Kategori Ekle</span> </a>
                            </h3>
                        </div>
                        ...
                        <div class="card-body">
                            <table id="pages" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $category['id'] }}</td>
                                        <td> <a class="" href="{{ url('NPanel/products/categories/subcategories/' . $category['id']) }}">{{ $category['title'] }}</a></td>
                                        <td>
                                            @php
                                            $count = 0;
                                            @endphp
                                            @foreach ($categories as $cat)
                                            @if ($cat['subId'] == $category['id'])
                                            @php
                                            $count++;
                                            @endphp
                                            @endif
                                        ...
                                        <td>
                                            <a class="btn btn-dark" href="{{ url('NPanel/products/categories/crud/' . $category['id']) }}"><i class="fas fa-edit"></i></a>
                                            <button class="btn btn-danger" data-toggle="modal" data-target="#exampleModal-{{ $category['id'] }}">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="{{ url('NPanel/products/categories/delete/' . $category['id']) }}" class="btn btn-primary">Evet</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
