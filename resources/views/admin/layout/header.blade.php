  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
          ...
          <li class="nav-item d-none d-sm-inline-block">
              <a href="/NPanel/dashboard" class="nav-link">Hoş Geldin
                  <strong>
          ...
          <li class="nav-item d-none d-sm-inline-block">
              <a href="{{ url('NPanel/dashboard') }}" class="nav-link">Anasayfa</a>
          </li>
          <li class="nav-item d-none d-sm-inline-block">
              <a href="{{ url('NPanel/logout') }}" class="nav-link">Çıkış Yap</a>
          </li>
      </ul>
