                    ...
                    <div class="col-12">
                        <div class="card card-primary card-outline card-outline-tabs">
                            <form name="cmsForm" id="cmsForm"
                                @if (empty($blogs['id'])) action="{{ url('NPanel/blogs/crud') }}" @else
                            action="{{ url('NPanel/blogs/crud/' . $blogs['id']) }}" @endif
                                method="post">
                                @csrf
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="title"
                                                                    name="title"
                                                                    @if (!empty($blogs['title'])) value="{{ $blogs['title'] }}" @endif />
                                                            </div>
                                                            <!-- /.form-group -->
                                                        </div>
                                                        <!-- /.col -->
                                                        <div class="col-md-6">
                                                            <!-- /.form-group -->
                                                            <div class="form-group">
                                                                <label for="subPage">Blog Başlığı</label>
                                                                <select class="form-control select2bs4" style="width: 100%;"
                                                                    name="subPage" id="subPage">
                                                                    <option selected="selected" value="0"> Kategori
                                                                        Seçin
                                                                    </option>
                                                                    @foreach ($allCategories as $subCategories)
                                                                        <option value="{{ $subCategories['id'] }}"
                                                                            @if (!empty($blogs['categoryId']) && $blogs['categoryId'] == $subCategories['id']) selected @endif>
                                                                            {{ $subCategories['title'] }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                                ...
                                                                <div class="col-md-2">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number" class="form-control"
                                                                            ...
                                                                            @if (!empty($blogs['orderNo'])) value="{{ $blogs['orderNo'] }}" @endif />
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="checkbox" name="status" id="status"
                                                                            checked
                                                                            @if (!empty($blogs['status'] === 1)) checked @endif
                                                        ...
                                                        <div class="col-md-12 mt-3 border-top pt-3">
                                                            <div class="form-group">
                                                                <label for="shortDescription">Blog Kısa
                                                                    Açıklaması</label><br>
                                                                <textarea name="shortDescription" class="col-md-12 form-control">
@if (!empty($blogs['shortDescription']))
                                        ...
                                        <div class="tab-pane fade" id="custom-tabs-four-messages" role="tabpanel"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="metaUrl" name="metaUrl"
                                                    @if (!empty($blogs['url'])) value="{{ $blogs['url'] }}" @endif
